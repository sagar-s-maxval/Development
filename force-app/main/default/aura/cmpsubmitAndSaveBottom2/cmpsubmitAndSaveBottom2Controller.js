({ 
    init: function(component, event, helper) {
        ...
        { 
            ...
            //alert('Error on load '+ "v.VDTErrorlistsync");
            console.log('test=='+component.get("v.OtherBusinessSegment"));
            component.set("v.OtherBusinessSegment",component.get("v.OtherBusinessSegment")); 
            ...
            // alert('txt '+component.get("v.VDTPublicDisclosure22"));
            component.set("v.VDTPublicDisclosureDate",component.get("v.Question22PublicDisDate"));
           // alert('date in footer>>>>>'+ component.get("v.Question22PublicDisDate"));
            ...
            component.set("v.VDTEarlierUsedDate",component.get("v.Question23earlierUsed1Date"));
            ...
            component.set("v.VDTEarlierExternalUseDate",component.get("v.Question24ExternalUseDate"));
    ...
    handleChange : function(component, event, helper) 
    {
        ...
        //alert('inventor11--'+component.get("v.VDTTitle"));
        //alert('inventor15--'+component.get("v.OnsaveValidateInv"));
        //alert('inventor16--'+component.get("v.InvalidInvSearch"));
...
console.log('Test==='+OtherBusinessSegment);
              
             // Adding to fire the error msg from cmp2 to cmp1 -----***
            
            var Err = component.get("v.ErrorMessage");
           // alert(Err);
            var cmpevent = $A.get('e.c:ErrorEventToPassTopEvent');
            cmpevent.setParams({"ErrorMessageToTop":Err});
            cmpevent.fire();
        ...
        else
        {
            ...
            */
            ...
            for(var i=0; i < ListOfInventorsWithRole.length; i++)
            {
                ...
                console.log('listOfInventorIds==='+listOfInventorIds);
                ...
                listOfConcatenatedInfoInvs.push(recordval.Recid+'<#>'+recordval.RoleOfConception+'<#>'+primaryInventor);
    ...
    //Submit button conroller
    handleChange2 : function(component, event, helper) 
    {
        console.log('Test');
       /*alert('component.get("v.VDTPriorsubmissionEvent21")'+component.get("v.VDTPriorsubmissionEvent21"));
       ...
       //---------------------------SAVE BUTTON REPLACEMENT ----------------------------
        ...
        console.log('check BS'+component.get("v.VDTManagingSegment"));
        //alert('inventor12--'+component.get("v.VDTTitle"));
        // alert('prior text value--->'+component.get("v.VDTISPublicDisclosureCheckQ22"));
        ...
        if((component.get("v.VDTTitle") === " " )|| (component.get("v.VDTTitle") === null)|| (component.get("v.VDTTitle").length === 0) 
          // || (component.get("v.VDTManagingSegment") === " " )|| (component.get("v.VDTManagingSegment") === null)|| (component.get("v.VDTManagingSegment").length === 0)
          ...
          
           {
            ...
            if((component.get("v.VDTIsPriorsubmission21Event") === '')||(((component.get("v.VDTIsPriorsubmission21Event") === 'true')||(component.get("v.VDTIsPriorsubmission21Event") === true)) && ((component.get("v.VDTPriorsubmissionEvent21") === '') || (component.get("v.VDTPriorsubmissionEvent21") === null)|| (component.get("v.VDTPriorsubmissionEvent21").length === 0))))
            {
                if(component.get("v.VDTIsPriorsubmission21Event") === '')
                {
                    ErrorList.push(" 2.1 Prior Submission ");
                }
            ...
            if((component.get("v.VDTExternalUseChk") ==='')||(((component.get("v.VDTExternalUseChk") === 'true')||(component.get("v.VDTExternalUseChk") === true)) && ((component.get("v.VDTExternalUse") ==='') || (component.get("v.VDTExternalUse") === null)|| (component.get("v.VDTExternalUse").length === 0)) || ((component.get("v.VDTEarlierExternalUseDate") ==='') || (component.get("v.VDTEarlierExternalUseDate") === null)|| (component.get("v.VDTEarlierExternalUseDate").length === 0))
               ))
          ...
          // Added to sync ---  
            ...
            var booleanvalue = component.get("v.BottomBooleanValue");
           // alert('booleanvalue>>>'+booleanvalue);
            if(piorvalue == true  )
            {
               
               	component.set("v.BottomBooleanValue",false);
              //  alert('setting in comp2 '+component.get("v.BottomBooleanValue"));
                component.set("v.VDTErrorlistsync",'');
    ...
    {
        var Summary = event.getParam("InventionSummary");
        component.set("v.VDTSummary",Summary);
    ...
    setManagingSegment : function(component, event, helper)
 {
     ...
     //   component.set("v.ManagingSegments",component.get("v.VDTManagingSegment"));
    },
   ...
   setQ23Datecheck : function(component, event, helper)
    ...
    setQ24Datecheck : function(component, event, helper)
    {
        ...
        component.set("v.Question23earlierUsed1Date",component.get("v.VDTEarlierUsedDate"));
    },
    setQ25Datecheck : function(component, event, helper)
    {
        ...
        component.set("v.Question24ExternalUseDate",component.get("v.VDTEarlierExternalUseDate"));
    },
    ...
    setConfidentialityTxt : function(component, event, helper)
    {
        ...
        component.set("v.VDTThirdPartyConfidentiality",event.getParam("ThirdPartyConfidentiality"));
        component.set("v.Confidentialityadded",temp);
    ...
    //------------ sync from first cmp--------
    SetErrormessage : function(component, event)
    {
        var Errors = event.getParam('ErrorMessage2');
        //alert(Errors);
       	var temp= component.set("v.BottomBooleanValue",true);
    ...
    setBusinessSegment:function(component, event){
        var temp = event.getParam("ManagingSegment");
